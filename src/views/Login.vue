  ...
  <div class="d-flex justify-content-center align-items-center h-100 flex-column">
    ...
    <b-form>
      <b-list-group class="mb-5">
        ...
        <b-button block variant="primary" class="mt-3" :disabled="loading" @click="login">Login</b-button>

        <div class="border-top mt-4  mb-3 w-75 text-center align-self-center"></div>

        <div class="text-center">
          <span>Do not have account?</span>
          <router-link tag="b-link" :to="{name: 'Register'}" class="pt-2"> Register your owns now.</router-link>
        </div>
      </b-list-group>
    </b-form>
  </div>
